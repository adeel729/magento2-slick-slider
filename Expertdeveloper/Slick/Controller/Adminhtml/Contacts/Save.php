...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Expertdeveloper\Slick\Model\ResourceModel\Contact\CollectionFactory
     */
    ...
    public function __construct(
        Context $context,
        \Magento\Backend\Helper\Js $jsHelper,
        \Expertdeveloper\Slick\Model\ResourceModel\Contact\CollectionFactory $contactCollectionFactory
    ) {
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Expertdeveloper\Slick\Model\Contact $model */
    ...
    public function saveProducts($model, $post)
    {
        ...
        if (isset($post['products'])) {
            ...
            try {
                ...
                $table = $this->_resources->getTableName(\Expertdeveloper\Slick\Model\ResourceModel\Contact::TBL_ATT_PRODUCT);
