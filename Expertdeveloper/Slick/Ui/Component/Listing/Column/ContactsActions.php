...
namespace Expertdeveloper\Slick\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const CONTACTS_URL_PATH_EDIT = 'slick/contacts/edit';
    const CONTACTS_URL_PATH_DELETE = 'slick/contacts/delete';
